...
grpc: protoc-all
	...
	PATH="$(GOBIN):$(PATH)" protoc --proto_path=vendor/github.com/ledgerwatch/interfaces --go_out=gointerfaces --go-grpc_out=gointerfaces -I=$(PROTOC_INCLUDE) \
		--go_opt=Mtypes/types.proto=github.com/tenderly/erigon/erigon-lib/gointerfaces/types \
		--go-grpc_opt=Mtypes/types.proto=github.com/tenderly/erigon/erigon-lib/gointerfaces/types \
